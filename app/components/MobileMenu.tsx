...
export default function MobileMenu({ isOpen, onClose, links }: MobileMenuProps) {
  return (
    ...
    >
      {/* gap-6 yerine dikey aralığı gap-3 yaparak menüleri birbirine yaklaştırdık */}
      <div className="flex flex-col items-center gap-3 text-center w-full px-6 pt-20">
        ...
        {links.map((link) => (
          <Link 
            ...
            href={link.href} 
            onClick={onClose} 
            {/* !text-[11px] kullanarak font boyutunu kesin olarak küçülttük ve satır yüksekliğini sıkıştırdık */}
